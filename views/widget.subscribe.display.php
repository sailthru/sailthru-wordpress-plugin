<?php
 ...
 <div class="sailthru-signup-widget">
     <div class="sailthru_form">
        ...
        ?>
         <form method="post" action="#" id="sailthru-add-subscriber-form" role="form">
            ...
            <div class="sailthru_form_input input-group">
                ...
                <input type="text" name="first_name" id="sailthru_first_name" value=""  class="form-control"/>
            </div>
            <?php } ?>
            ...
            <div class="sailthru_form_input input-group">
                ...
                <input type="text" name="last_name" id="sailthru_last_name" value="" class="form-control"/>
            </div>
            <?php } ?>

            <div class="input-group sailthru_form_input">
                    <input type="text" name="email" id="sailthru_email" value="" class="form-control"/>
                    <span class="input-group-btn">
                        <input type="submit" value="Subscribe" class="btn btn-reverse"/>
                    </span>
            </div>
