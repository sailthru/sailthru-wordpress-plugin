...
<?php else : ?>
	...
	<div id="dashboard-widgets-wrap wrap">
		<div id="sailthru-template-choices" class="metabox-holder columns-2">
			<div class="welcome-panel" id="welcome-screen-header">Smart Data</div>
			<div class="row options">
				...
				<div class="option-box" id="support">
					<h3>Support</h3>
					<p>If you have any immediate questions, please don't hesitate to contact us at 877-812-8689  or <a href="mailto:support@sailthru.com">support@sailthru.com</a></p>
