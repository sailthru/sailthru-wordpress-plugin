...
class Sailthru_Subscribe_Widget extends WP_Widget {
    ...
    function add_subscriber() {
        ...
        if ( !empty($_POST['sailthru_nonce']) && ! wp_verify_nonce( sanitize_text_field($_POST['sailthru_nonce']), 'add_subscriber_nonce' ) ) {
        ...
        if ( $client ) {
                ...
                if ( ! empty( $customfields[ $field_key ]['sailthru_customfield_name'] ) ) {
                    ...
                    if ( ! empty( $_POST[ 'custom_' . $name_stripped ] ) ) {
                        ...
                        if ( is_array( $_POST[ 'custom_' . $name_stripped ] ) ) {
                            ...
                            $custom_name = 'custom_' . $name_stripped;
                            if (!empty($_POST[ $custom_name ])) {
                                foreach ( sanitize_text_field($_POST[ $custom_name ]) as $val ) {
            ...
            $sailthru_email_list = !empty($_POST['sailthru_email_list']) ? sanitize_text_field( $_POST['sailthru_email_list'] ) : '';
            ...
            $recaptcha_token = !empty($_POST['captcha_token']) ? sanitize_text_field( $_POST['captcha_token'] ) : '';
